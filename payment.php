...
<!-- Mirrored from remtsoy.com/tf_templates/tf-bookify-demo/flight-payment-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jan 2020 15:56:19 GMT -->
<head>
                ...
                <div class="theme-search-results-item theme-payment-page-item-thumb">
                  <div class="row" data-gutter="20">
                    <div class="col-md-9 ">
                      ...
                      <h5 class="theme-search-results-item-title">London, LTN &nbsp;&rarr;&nbsp; New York, LGA</h5>
                            ...
                            <div class="row">
                              <div class="col-md-3 ">
                                <div class="theme-search-results-item-flight-details-info">
                                  ...
                                  <p class="theme-search-results-item-flight-details-info-fly-time">17h 30m</p>
                    ...
                    <div class="col-md-3 ">
                      <div class="theme-search-results-item-img-wrap">
                        <img class="theme-search-results-item-img _mob-h" src="img/airline-logo/aa.jpg" alt="Image Alternative text" title="Image Title"/>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-6 ">
                    <div class="theme-payment-page-form-item form-group">
                      <i class="fa fa-angle-down"></i>
                      <select class="form-control">
                        <option>**** **** **** 6843 MasterCard</option>
                        <option>**** **** **** 2585 MasterCard</option>
                        <option>**** **** **** 6783 MasterCard</option>
                        <option>**** **** **** 3172 MasterCard</option>
                        <option>**** **** **** 1793 Visa</option>
                      </select>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-md-3">
            <div class="theme-footer-section theme-footer-">
              ...
              <div class="theme-footer-brand-text">
                <p>Duis viverra duis commodo ornare ante libero maecenas mattis amet conubia fusce ultricies auctor rhoncus</p>
                <p>Duis elementum cursus magnis phasellus in sollicitudin vivamus aenean aenean habitasse eleifend fermentum sit ante</p>
              </div>
            </div>
          </div>
          <div class="col-md-5">
